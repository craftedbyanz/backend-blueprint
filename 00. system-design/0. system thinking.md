...
- [SYSTEM THINKING](#system-thinking)
  ...
  - [Nội dung báo cáo](#nội-dung-báo-cáo)
    - [1. Định lý CAP và khái niệm eventual consistency](#1-định-lý-cap-và-khái-niệm-eventual-consistency)
    - [2. Khái niệm throughput và latency](#2-khái-niệm-throughput-và-latency)
    - [3. Task Queue khác gì Message Queue](#3-task-queue-khác-gì-message-queue)
    - [4. Các phương pháp để scale database (MySQL)](#4-các-phương-pháp-để-scale-database-mysql)
    - [5. Khái niệm về Load balancer và NGINX](#5-khái-niệm-về-load-balancer-và-nginx)
    - [6. Vai trò của cache, các thuật toán apply cho cache (LRU, LFU)](#6-vai-trò-của-cache-các-thuật-toán-apply-cho-cache-lru-lfu)
    - [7. Thông tin cơ bản của Redis](#7-thông-tin-cơ-bản-của-redis)
